        ...
        {teams.length === 0 ? (
          ...
          teams.map((team) => {
            ...
            return (
              ...
              {latestPulse ? (
                <div className="mt-3 rounded-lg border border-slate-200/80 bg-slate-50 px-3 py-2">
                  <p className="text-sm font-medium text-slate-900">{getPulseDisplayTitle(latestPulse)}</p>
              ...
              <div className="mt-3">
                <Link
                  ...
                  className="inline-flex min-h-10 items-center justify-center rounded-lg border border-slate-300 px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50"
                >
                  Sjá púlsa
                </Link>
              </div>
